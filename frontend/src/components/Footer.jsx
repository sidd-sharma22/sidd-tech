    ...
    <footer className="w-full border-t border-warm-200 mt-20 bg-white/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="pt-8 border-t border-warm-200 flex flex-col md:flex-row items-center justify-between gap-4 relative">
          {/* Centered Copyright - absolute on desktop to keep it truly centered while right text is right-aligned */}
          <div className="md:absolute md:left-1/2 md:-translate-x-1/2 text-sm text-warm-800/60 font-medium text-center">
